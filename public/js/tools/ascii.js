...
function renderFonts(fonts) {
  ...
  fontItemList.querySelectorAll('.combobox-container .dropdown-item').forEach(el => {
  ...
  fontItemList.querySelectorAll('.combobox-container .dropdown-item').forEach(el => observer.observe(el));
}
